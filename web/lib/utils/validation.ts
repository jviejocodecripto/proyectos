...
export const createProjectSchema = z.object({
  ...
  repositoryUrl: z
    ...
    .url('URL inválida')
    .regex(
      /^https:\/\/(github\.com|gitlab\.codecrypto\.academy)\/[\w-]+\/[\w.-]+(\/.*)?$/,
      'Debe ser una URL válida de GitHub (https://github.com/usuario/repositorio) o GitLab (https://gitlab.codecrypto.academy/usuario/repositorio) con subdirectorio opcional'
    ),
