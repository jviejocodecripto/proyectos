...
export default function TeacherProjectDetailsPage({
  params
}: {
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Link
            ...
            className="inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-lg font-medium hover:bg-gray-700 transition"
          >
            <svg
          ...
          >
            ...
            {project.status === 'evaluated' ? 'Ver Evaluación' : 'Evaluar'}
          </Link>
        </div>
      </div>
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div>
              ...
              <p className="text-gray-900 font-medium">{project.studentEmail}</p>
            </div>
            <div>
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Por: {project.evaluations.videoDemo.evaluatedBy}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Por: {project.evaluations.repository.evaluatedBy}
                    </p>
                  </div>
                </div>
              </div>
